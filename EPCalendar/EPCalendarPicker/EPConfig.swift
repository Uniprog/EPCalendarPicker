...
//  EPCalendar
//
//  Created by Alexanedr on 11/9/16.
...
public struct EPConfig {
    
    public static var headerMonthColor = UIColor.lightGray
    ...
    public static var otherMonthDateColor = UIColor.lightGray
